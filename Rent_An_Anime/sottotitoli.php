...
<body>
	...
	$sql = "SELECT ID, nome, audio, sottotitoli, data_uscita, stagione, studio, genere, episodi, durata, quantita, prezzo, smallimg, descrizione FROM Anime WHERE sottotitoli='" . $_GET["sottotitoli"] . "' AND quantita>0";
