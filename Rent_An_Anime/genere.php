...
<body>
	...
	<hr>
	<div class="annunci">
		ミミ◦❧◦°˚°◦.¸¸◦°´❤*•.¸♥⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀ANIME DEL GENERE CERCATO⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀♥¸.•*❤´°◦¸¸.◦°˚°◦☙◦彡彡
	</div>

	<?php

	$sql = "SELECT ID, nome, audio, sottotitoli, data_uscita, stagione, studio, genere, episodi, durata, quantita, prezzo, smallimg, descrizione FROM Anime WHERE genere='" . $_GET["genere"] . "' AND quantita>0";
