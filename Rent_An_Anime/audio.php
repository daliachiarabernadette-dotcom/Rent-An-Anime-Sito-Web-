...
<body>
	...
	$sql = "SELECT ID, nome, audio, sottotitoli, data_uscita, stagione, studio, genere, episodi, durata, quantita, prezzo, smallimg, descrizione FROM Anime WHERE audio='" . $_GET["audio"] . "' AND quantita>0";
